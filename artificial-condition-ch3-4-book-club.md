---
tags: book-club, artificial-condition, martha-wells
---
# Book Club
## Chapter 3
### The Power Dynamic
- Jumping back in after Murderbot intentionally shuts down for 4 hours during an argument with ART, which ART describes as "childish".
- Murderbot is furious, largely because it feels powerless
- During watching media, Murderbot analyzed the ship and found 27 ways to disable it and 3 ways to blow it up. Decides against "mutually assured destruction".
  - Is Murderbot actually dangerous to ART, or is this just a coping mechanism to feel like it has some control in the situation?
...
### Defining Friendship and Trust
- ART claims, "We are friends now."
- Murderbot rejects this, stating that constructs cannot be friends because they are both beholden to human orders, arguing that a human could order ART to purge Murderbot, or order Murderbot to destroy ART.
- ART traps Murderbot in a "conversational dead end," forcing Murderbot to admit that there are no humans present right now to give those orders.
- Murderbot realizes ART is manipulating the conversation to make Murderbot think for itself.
...
### Confession of RaviHyral
- Murderbot finally admits why it is here and confesses to the incident at RaviHyral Mining Facility Q Station where it killed a large number of clients.
- Since Murderbot has organic neural tissue, memory purges are never 100% effective.
	- Will going to RaviHiral Mining Facility Q trigger memories?
- Did the governor module fail catastrophically (an accident), or did Murderbot hack the module specifically to kill them?
