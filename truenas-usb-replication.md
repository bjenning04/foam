...
Go to the **System** tab in the TrueNAS UI and click **Shell**. Drop into the TrueNAS Shell. Before starting, we need to freeze the dataset in time. Replace source-pool/data with the actual name of the dataset you are backing up.
...
Once inside tmux, run the pipe command to copy the snapshot over to your external drive:
